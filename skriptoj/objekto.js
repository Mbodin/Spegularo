	...
	with (Spegularo){
		...
		addToContainer ([
			...
			{ n: "createObject", o: function (name, constructor){
					// This function creates and add a constant object in “Objects”.
					// In this most general case, objects are given by a function returning
					// a new object.  This function takes care that the prototype of this
					// object is to be well set.
					// It takes as argument the name of the object to be created and an
					// initiator function, returning an object.
					if (name in Objects)
						internalError ("createObject",
							"“" + name + "” already in object “Objects”.")
			...
			{ n: "createSimpleObject", o: function (name, obj){
					...
					createObject (name, constant (obj))
				} },
			{ n: "ObjectPrototype", o: {
					...
					// “Colors.ColorName”) or a color string (i.e. the result of such a
					// function).  If it is a function, it will be called while displaying
					// it (if it is displayed) with the cell’s luminosity as an argument,
					// returning the corresponding color string.
					...
					//	 because of the name!
					collision: addConstruction ("collision", [
							"collisionConcrete",
					...
					type: addConstruction ("objectType", [
							"static",
							"dynamic",
							"active"],
						"static"),
					...
					move: function (dir, cancel){
							if (cancel === undefined)
								cancel = Constructions.cancel.noCancel
